...
% Add background ONLY on LaTeX page 41
\AddToShipoutPictureBG{%
  \AtPageLowerLeft{%  <-- anchors the image at the absolute lower-left
    \ifthenelse{\value{page}=41}{%
      \includegraphics[page=2,width=\paperwidth,height=\paperheight]{scode.pdf}%
    }{}%
  }%
}
...
\usepackage{graphicx}
\usepackage{geometry} % in preamble
\usepackage{fancyvrb}
\usepackage[export]{adjustbox}  % in preamble, allows center alignment with scaling
% --------------------------------------------------------------------
\usepackage{listings}
...
\lstdefinestyle{plainstyle}{
    ...
    showstringspaces=false      % show spaces normally
}
% --------------------------------------------------------------------
